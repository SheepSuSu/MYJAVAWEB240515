...
public class UserBankOBean {
	...
	public static void addMoney(String cardname,String password,String username,double addmoney){
		try {
			...
			double money1=0.0;
			double money2=0.0;
			if (DAOFactory.getBankDAOInstance().selectBankByUser(username)==null){
				money2=addmoney;
			}else{
				money1=DAOFactory.getBankDAOInstance().selectBankByUser(username).getMoney();
				money2=money1+addmoney;
			}
