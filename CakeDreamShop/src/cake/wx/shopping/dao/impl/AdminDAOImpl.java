...
//			}
//			else{
//				System.out.println("yes!I find user"+username);
//			}
			if (rs.next()) {
	...
	public boolean pd_admin_exist(String adminName) throws Exception{
		boolean pd;
		...
		try {
			...
			ResultSet rs = pstmt.executeQuery();
			if(rs.next()){
				System.out.println("yes!I find user"+adminName);
				pd=true;
			}
			else{
				pd=false;
