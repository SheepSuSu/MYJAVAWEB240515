...
<div STYLE="background: linear-gradient(to bottom,papayawhip, #d6fff8);">
  <table cellspacing="0" border="1" id="large" align="center">
    <caption style="color: deeppink">饮品销售情况</caption>
    <tr>
      <th>商品名</th>
      <th>销量</th>
      <th>总收益</th>
    ...
    <%
      List<List<String>> formList=DAOFactory.getProductDAOInstance().showItemSale(2);
      if (formList.size()==0){
        System.out.println("DrinkSale.select Wrong!!!");
      }
      System.out.println("This is drink sale situation!");
